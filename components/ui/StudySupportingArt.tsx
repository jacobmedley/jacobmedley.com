...
type ArtDefinition = { eyebrow: string; mode: ArtMode; center?: ArtNode; nodes: ArtNode[] }

const ART: Record<SupportingArtKind, ArtDefinition> = {
  'dental-platform': {
    eyebrow: 'Shared Platform', mode: 'ecosystem',
    center: { label: 'Shared Platform', icon: 'fa-thin fa-diagram-project' },
    nodes: [
      { label: 'Product Data', icon: 'fa-thin fa-database' },
  ...
  'dental-mvp-two': { eyebrow: 'Iteration 2', mode: 'iteration', nodes: [
  ...
  'dental-mvp-three': { eyebrow: 'Iteration 3', mode: 'iteration', nodes: [
  ...
  'dental-mvp-four': { eyebrow: 'Iteration 4', mode: 'iteration', nodes: [
  ...
  hydra: { eyebrow: 'Shared Vocabulary', mode: 'mark', nodes: [] },
