...
function DesignSystem() {
  return <div className="featured-design-system">
    <svg viewBox="0 0 1000 440" preserveAspectRatio="xMidYMid slice">
      <defs><pattern id="hydra-grid" width="32" height="32" patternUnits="userSpaceOnUse"><path d="M32 0H0V32" fill="none" stroke="currentColor" strokeOpacity=".1" /></pattern></defs>
      <rect width="1000" height="440" fill="url(#hydra-grid)" />
